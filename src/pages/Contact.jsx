...
export default function Contact({ t }) {
  ...
  return (
    <section className="max-w-4xl mx-auto py-12 px-4 text-slate-100">
      ...
      <div className="rounded-2xl border border-slate-700/70 bg-slate-900/60 shadow-xl shadow-black/30 p-6 sm:p-8">
        ...
        >
          ...
          <div className="flex flex-col">
            <label className="text-sm font-medium text-slate-300 mb-2">{t.contact.labels.name}</label>
            <input
              type="text"
              name="name"
          ...
          <div className="flex flex-col">
            <label className="text-sm font-medium text-slate-300 mb-2">{t.contact.labels.email}</label>
            <input
              type="email"
              name="email"
          ...
          <div className="flex flex-col">
            <label className="text-sm font-medium text-slate-300 mb-2">{t.contact.labels.message}</label>
            <textarea
              name="message"
          ...
          <a
            ...
            className="mt-2 flex items-center justify-center gap-2 text-accent hover:underline"
          >
